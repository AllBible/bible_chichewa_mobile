...
class ScreenAboutUs extends StatefulWidget {
  ...
  @override
  _ScreenAboutUsState createState() => _ScreenAboutUsState();
}
...
class _ScreenAboutUsState extends State<ScreenAboutUs> {
  ...
  void _onShare() => SharePlus.instance.share(
    ShareParams(
      text:
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          IconButton(
                            onPressed: () => _loadUrl(
                              'https://facebook.com/m2kdevelopments',
                            ),
                            style: ButtonStyle(
                              backgroundColor: WidgetStateProperty.all(
                                Colors.white,
                          ...
                          IconButton(
                            onPressed: () => _loadUrl(
                              'https://instagram.com/m2kdevelopments',
                            ),
                            style: ButtonStyle(
                              backgroundColor: WidgetStateProperty.all(
                                Colors.white,
