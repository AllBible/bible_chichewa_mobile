...
import 'package:chichewa_bible/components/alphabutton.dart';
...
class _ScreenAppState extends State<ScreenApp> {
  ...
  void _onChapter(int book, int chapter, BuildContext c) {
    if (chapter > 0) {
      Navigator.pop(c);
  ...
  void _onBook(int bookIndex) {
    ...
    var maxChapters = _controllerBible.bible.value.getChapterCount(
      BOOK.values[bookIndex],
    );
                    ...
                    child: Column(
                      ...
                      children: [
                        ListTile(
                          ...
                          title: Text(
                            _controllerBible.bible.value.getBooks()[bookIndex],
                            style: TextStyle(
                              color: _controllerBible.lightMode.value
                                  ? Colors.grey
                                  : Colors.white,
                            ...
                            Row(
                              ...
                              children: [
                                AlphaButton(
                                  ...
                                  onPressed: () {
                                    setStateF(() {
                                      _chapterNumber = (_chapterNumber / 10)
                                          .floor();
                                      if (_chapterNumber > maxChapters) {
                                        _chapterNumber = maxChapters;
                                      }
  ...
  void _onSearch(BuildContext context) {
    showSearch(
      context: context,
      delegate: WidgetSearchMenu(
        names: _controllerBible.bible.value.getBooks(),
        onBookSelected: _onBook,
      ),
    );
  }
